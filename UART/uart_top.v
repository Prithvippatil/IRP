...
// Date        : Thu Apr 27 14:53:55 2023
// Host        : BLUESPEC-SVR2 running 64-bit CentOS Linux release 7.3.1611 (Core)
// Command     : write_verilog /home/user54/Desktop/uart_verilog/uartnet.v
// Design      : uart_top
...
module fifo_11_64
  ...
  output [0:0]\fifostatus_reg[5]_0 ;
  output rxrdy_n_OBUF;
  ...
  memory_64_11 bram1
       (.AR(AR),
        ...
        .mr_IBUF(mr_IBUF),
        .\read_addr_reg[5] (\read_addr_reg[5]_0 ),
        .\read_addr_reg[5]_0 (\read_addr_reg[5]_1 ),
        .\read_addr_reg[5]_1 (\read_addr_reg[5]_2 ),
        .\read_addr_reg[5]_2 (\read_addr_reg[5]_3 ),
        .read_addr_reg__0(read_addr_reg__0),
        .\write_addr_reg[5] (\write_addr_reg[5]_0 ),
        .write_addr_reg__0(write_addr_reg__0));
  ...
  LUT6 #(
    ...
    \read_addr[5]_i_1__0 
       (.I0(read_addr_reg__0[5]),
        .I1(read_addr_reg__0[4]),
        .I2(read_addr_reg__0[0]),
        .I3(read_addr_reg__0[1]),
        .I4(read_addr_reg__0[2]),
        .I5(read_addr_reg__0[3]),
        .O(plusOp__1[5]));
  FDCE #(
    .INIT(1'b0)) 
    \read_addr_reg[0] 
  ...
  LUT6 #(
    ...
    \write_addr[5]_i_1__0 
       (.I0(write_addr_reg__0[5]),
        ...
        .I2(write_addr_reg__0[4]),
        .I3(write_addr_reg__0[2]),
        .I4(write_addr_reg__0[1]),
        .I5(write_addr_reg__0[0]),
        .O(plusOp__2[5]));
  FDCE #(
    .INIT(1'b0)) 
    \write_addr_reg[0] 
  ...
  LUT2 #(
    ...
    \write_nextgray[3]_i_1__0 
       (.I0(write_addr_reg__0[3]),
        .I1(write_addr_reg__0[4]),
        .O(p_0_out[3]));
  LUT2 #(
    .INIT(4'h6)) 
    \write_nextgray[4]_i_1__0 
       (.I0(write_addr_reg__0[4]),
        .I1(write_addr_reg__0[5]),
        .O(p_0_out[4]));
  FDCE #(
    .INIT(1'b0)) 
...
module fifo_8_64
  ...
  memory_64_8 bram1
       (.AR(AR),
        .Q({write_addr_reg__0[5:2],write_addr_reg__0[0]}),
        .WENB(WENB),
        .a_IBUF(a_IBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .cs_IBUF(cs_IBUF),
        ...
        .\tx_shift_reg_reg[1] ({read_addr_reg__0[5:2],read_addr_reg__0[0]}),
...
module memory_64_11
  ...
  input [10:0]D;
  input [5:0]write_addr_reg__0;
  input \write_addr_reg[5] ;
  input full_s;
  input [0:0]\intr_id_reg_int_reg[2]_3 ;
  input mr_IBUF;
  input \intr_id_reg_int_reg[2]_4 ;
  input [5:0]read_addr_reg__0;
  input [0:0]AR;
  input clk_IBUF_BUFG;
...
module receiver
  ...
  output \fifo_control_reg_int_reg[0] ;
  output \fifo_control_reg_int_reg[0]_0 ;
  output [3:0]\rx_buffer_reg_int_reg[7]_0 ;
  output \fifo_control_reg_int_reg[0]_1 ;
  ...
  wire [3:0]\rx_buffer_reg_int_reg[7]_0 ;
  wire rx_fifo_n_17;
  wire rx_fifo_n_7;
  wire rx_ready_n_fifo;
  wire rx_ready_n_fifo_sig;
  ...
  FDRE #(
    ...
    \rx_buffer_reg_int_reg[1] 
       (.C(clk_IBUF_BUFG),
        .CE(\rx_buffer_reg_int[7]_i_1_n_0 ),
        .D(rx_shift_reg[1]),
        .Q(\rx_buffer_reg_int_reg[7]_0 [0]),
        .R(mr_IBUF));
  FDRE #(
    .INIT(1'b0)) 
  ...
  FDRE #(
    ...
    \rx_buffer_reg_int_reg[5] 
       (.C(clk_IBUF_BUFG),
        .CE(\rx_buffer_reg_int[7]_i_1_n_0 ),
        .D(rx_shift_reg[5]),
        .Q(\rx_buffer_reg_int_reg[7]_0 [1]),
        .R(mr_IBUF));
  FDRE #(
    .INIT(1'b0)) 
    \rx_buffer_reg_int_reg[6] 
       (.C(clk_IBUF_BUFG),
        .CE(\rx_buffer_reg_int[7]_i_1_n_0 ),
        .D(rx_shift_reg[6]),
        .Q(\rx_buffer_reg_int_reg[7]_0 [2]),
        .R(mr_IBUF));
  FDRE #(
    .INIT(1'b0)) 
    \rx_buffer_reg_int_reg[7] 
       (.C(clk_IBUF_BUFG),
        .CE(\rx_buffer_reg_int[7]_i_1_n_0 ),
        .D(rx_shift_reg[7]),
        .Q(\rx_buffer_reg_int_reg[7]_0 [3]),
        .R(mr_IBUF));
  fifo_11_64 rx_fifo
       (.AR(AR),
        .D({din,\rx_buffer_reg_int_reg[7]_0 [3:1],rx_buffer_reg_int[4:2],\rx_buffer_reg_int_reg[7]_0 [0],rx_buffer_reg_int[0]}),
        .E(E),
        .Q(Q),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .\dout[0] (\dout[0] ),
        ...
        .\fifostatus_reg[5]_0 (\fifostatus_reg[5] ),
        .\intr_ena_reg_int_reg[2] (\intr_ena_reg_int_reg[2] ),
        .intr_id_reg(intr_id_reg[1]),
...
module uart_top
  ...
  wire u_registers_n_70;
  wire u_registers_n_71;
  ...
  baud_gen u_baud_gen
       (.CO(data0),
        .Q(div_latch_reg),
        .S({u_registers_n_61,u_registers_n_62,u_registers_n_63,u_registers_n_64}),
        .baud_int1(baud_int1),
        .baud_int_reg_0(u_registers_n_78),
        .baudout_n_OBUF(baudout_n_OBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clk_rx_int0(clk_rx_int0),
        ...
        .count0_carry__0_i_4_0({u_registers_n_50,u_registers_n_51,u_registers_n_52}),
        .count0_carry_i_1_0({u_registers_n_53,u_registers_n_54,u_registers_n_55,u_registers_n_56}),
        .count0_carry_i_3_0({u_registers_n_57,u_registers_n_58,u_registers_n_59,u_registers_n_60}),
        .\count_reg[31]_0 (u_baud_gen_n_5),
        .\count_reg[31]_1 (u_registers_n_81),
        .\count_reg[31]_2 (u_registers_n_49),
  ...
  interrupt u_interrupt
       (.a_IBUF(a_IBUF),
        ...
        .\intr_id_reg_int_reg[1]_1 (u_registers_n_47),
  ...
  receiver u_receiver
       (.AR(rx_fifo_reset),
        ...
        .\FSM_sequential_rx_state_reg[1]_0 (u_registers_n_71),
        .\FSM_sequential_rx_state_reg[1]_1 (u_registers_n_76),
        .\FSM_sequential_rx_state_reg[2]_0 (u_receiver_n_28),
        .\FSM_sequential_rx_state_reg[2]_1 (u_receiver_n_29),
        .\FSM_sequential_rx_state_reg[2]_2 (u_registers_n_70),
        .\FSM_sequential_rx_state_reg[2]_3 (u_registers_n_72),
        .\FSM_sequential_rx_state_reg[3]_0 ({rx_state[3],rx_state[1:0]}),
        .\FSM_sequential_rx_state_reg[3]_1 (u_receiver_n_27),
        .Q({u_registers_n_26,u_registers_n_27,fifo_enable[3],fifo_enable[0]}),
        .\a[0] (u_receiver_n_5),
        .a_IBUF(a_IBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clk_rx_rise(clk_rx_rise),
        ...
        .fifo_overrun_reg_1(u_registers_n_47),
        ...
        .\rx_buffer_reg_int_reg[7]_0 ({rx_buffer_reg_int[7:5],rx_buffer_reg_int[1]}),
        .\rx_shift_reg_reg[5]_0 (u_registers_n_69),
  ...
  registers u_registers
       (.AR(tx_fifo_reset),
        ...
        .\FSM_sequential_rx_state_reg[0]_0 (u_receiver_n_26),
        .\FSM_sequential_rx_state_reg[3] (u_registers_n_69),
        .Q(div_latch_reg),
        .S({u_registers_n_61,u_registers_n_62,u_registers_n_63,u_registers_n_64}),
        .a_IBUF(a_IBUF),
        .baud_int1(baud_int1),
        .baud_int_reg(u_registers_n_78),
        .baud_int_reg_0(u_baud_gen_n_5),
        .baudout_n_OBUF(baudout_n_OBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clk_rx_int0(clk_rx_int0),
        .clk_rx_rise(clk_rx_rise),
        .\count_rx_reg[2] (u_receiver_n_19),
        .cs_IBUF(cs_IBUF),
        .\div_latch_reg_int_reg[12]_0 ({u_registers_n_53,u_registers_n_54,u_registers_n_55,u_registers_n_56}),
        .\div_latch_reg_int_reg[15]_0 ({u_registers_n_50,u_registers_n_51,u_registers_n_52}),
        .\div_latch_reg_int_reg[6]_0 (u_registers_n_49),
        .\div_latch_reg_int_reg[8]_0 (u_registers_n_46),
        .\div_latch_reg_int_reg[8]_1 ({u_registers_n_57,u_registers_n_58,u_registers_n_59,u_registers_n_60}),
        ...
        .\fifo_control_reg_int_reg[5]_0 (u_registers_n_65),
        .\fifo_control_reg_int_reg[6]_0 (u_registers_n_75),
        .\fifo_control_reg_int_reg[7]_0 ({u_registers_n_26,u_registers_n_27,tx_trigger_level,fifo_enable[3],fifo_enable[0]}),
        ...
        .\line_control_reg_int_reg[0]_1 (u_registers_n_71),
        .\line_control_reg_int_reg[0]_2 (u_registers_n_73),
        .\line_control_reg_int_reg[0]_3 (u_registers_n_76),
        .\line_control_reg_int_reg[1]_0 (u_registers_n_68),
        .\line_control_reg_int_reg[1]_1 (u_registers_n_70),
        .\line_control_reg_int_reg[1]_2 (u_registers_n_72),
        .\line_control_reg_int_reg[1]_3 (u_registers_n_74),
        .\line_control_reg_int_reg[4]_0 (u_registers_n_77),
        ...
        .\line_control_reg_int_reg[7]_2 (u_registers_n_45),
        .mr(u_registers_n_81),
        .mr_IBUF(mr_IBUF),
  ...
  transmitter u_transmitter
       (.AR(tx_fifo_reset),
        ...
        .\FSM_sequential_tx_state_reg[2]_0 (u_registers_n_70),
        .Q(tx_state),
        .a_IBUF(a_IBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clk_tx_fall(clk_tx_fall),
        .clk_tx_rise(clk_tx_rise),
        .cs_IBUF(cs_IBUF),
        .full_s_reg(u_registers_n_45),
        .mr_IBUF(mr_IBUF),
        .p_full_reg({tx_trigger_level,fifo_enable[0]}),
        .p_full_reg_0(u_registers_n_65),
        .parity_i_4(u_registers_n_68),
        .parity_reg_0(u_transmitter_n_2),
        .sout_OBUF(sout_OBUF),
        .sout_int_i_2(u_registers_n_74),
        .sout_int_reg_i_3_0(u_registers_n_77),
        .tx_empty(tx_empty),
        ...
        .\write_addr_reg[5]_0 (u_registers_n_47));
  IBUF wr_IBUF_inst
       (.I(wr),
        .O(wr_IBUF));
endmodule
